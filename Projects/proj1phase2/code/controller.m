function [F, M] = controller(t, s, s_des)
    ...
    %% PID parameters
    kp_position = [10; 10; 20]; % 8 8 18 ; 8 10 18
    kd_position = [8; 8; 8]; % 4 4 9 ; 4 6 9
    % ki_position = [0; 0; 0];
    kp_rotation = [3200; 3200; 3200]; % 2000 2000 2000
    kd_rotation = [90; 90; 90]; % 70 70 70
    % ki_rotation = [0; 0; 0];
    ...
    euler = [phi*(180/pi); theta*(180/pi); psi*(180/pi)];
