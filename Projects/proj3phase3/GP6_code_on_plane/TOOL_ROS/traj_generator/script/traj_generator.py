...
class CircleTrajectoryGenerator():
    def __init__(self):
        ...
        self._uav_pos_sub = rospy.Subscriber("/aug_ekf/ekf_fused_odom", Odometry, self._uav_pos_callback)
        ...
        if (self._is_init):
            if (self._is_traj):
                if(self._phase4):
                    ...
                    # print("traj")
                    if self._odom_time - self._start_time > self._path_time[14]:
                    ...
                    if (not is_traj_finished):
                        ...
                        des_z = msg.pose.pose.position.z
                    
                    des_x = des_x + self._hover_pos[0]
                    des_y = des_y + self._hover_pos[1]
                    des_z = des_z + self._hover_pos[2]
                    ...
                    des_x = self._hover_pos[0]
                    des_y = self._hover_pos[1]
